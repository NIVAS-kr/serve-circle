    ...
    <FooterWrapper>
      <div className="container_footer">
        <div className="footer_about">
          ...
          <p>
            #2/1, 1st Floor, 28th Cross Rd, 7th Block, Jayanagar, Bengaluru, Karnataka - 560070<br />
            +91 9620164576
          </p>
          <a href="mailto:support@servecircle.com" className="footer_nounderline">support@servecircle.com</a>
          <br />
          <p className="footer_copyright">
            Copyright &copy; {new Date().getFullYear()} <a href="https://www.servecircle.com/" className="footera_nocolor">ServeCircle.</a> All rights reserved.
          </p>
        </div>
